...
if(isset($_REQUEST['submit'])){
    ...
    $cmd="INSERT INTO `resume`( `name`, `address`, `contact`, `email`, `state`, `dob`, `nationality`, `gender`, `city`, `collegename`, `university`, `degree`, `percentage`, `grade`, `passingyear`,`language`, `database1`, `framework`, `API`, `companyname`, `jobtitle`, `experience`, `responsibilities`, `startdate`, `enddate`, `user_id`) 
        values('$name','$address','$contact','$email','$state','$dob','$nationality','$gender','$city','$collegename','$university','$degree','$percentage','$grade','$passingyear','$language','$database','$framework','$api','$companyname','$jobtitle','$experience','$Responsibilities','$startdate','$enddate','$id')";
      ...
      <div class="col-12">
          <div class="row">
              <div class="col-6">
                  ...
                  <input type="text" class="form-control " name="collegename1">
